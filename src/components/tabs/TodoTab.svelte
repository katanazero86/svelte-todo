...
<div class="flex flex-row items-center justify-between cursor-pointer divide-x divide-slate-200">
    <div class={`basis-1/2 flex justify-center hover:bg-violet-50 py-3 border-b border-transparent ${activeTab !== TAB_ITEMS[0] && noActiveClass}`}
    ...
    <div class={`basis-1/2 flex justify-center hover:bg-violet-50 py-3 border-b border-transparent ${activeTab !== TAB_ITEMS[1] && noActiveClass}`}
